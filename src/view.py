...
#==============================================================================
    ...
    def sh_report(self):
        ...
        self.label_name(m_type,row=4,col=2)
        self.label_name('Metrics:',row=5)
        self.label_name(list(m_acc.keys())[0],row=6)
        self.label_name(list(m_acc.values())[0],row=6,col=2)
...
#        horz = oscroll.add_hbar(self.left_frame,self.operator,3,0)
        ...
        self.operator.insert("sh",2,text="SH Report",tag='wicon')
...
#==============================================================================
    ...
    def on_run(self,rframe,alloperatorobjects):
        print(alloperatorobjects[1]['function'].__dict__)
        self.rframe = rframe
        try:
...
#==============================================================================
    def super_hack(self,obj_id):
        df = alloperatorobjects[obj_id]['function'].get_dataframe(self.fh.raw_data)
        self.c_len,self.m_type,self.m_acc = alloperatorobjects[obj_id]['function'].send_details()
        self.update_dataframe(df)
        
    
    def super_hack_report(self):
        return self.c_len,self.m_type,self.m_acc 
