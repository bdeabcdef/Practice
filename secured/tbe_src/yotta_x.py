...
#class RegressionAccuracy(Accuracy):
    def rmse(self):
        ...
        return {'Rmse':np.sqrt(mean_squared_error(self.actual, self.pred))}

    
#class ClassificationAccuracy(Accuracy):
    def f_score(self):
        from sklearn.metrics import f1_score
        return {'f1_score':f1_score(self.actual,self.pred, average='micro')}
    
    def acc_score(self):
        from sklearn.metrics import accuracy_score
        return {'Accuracy':accuracy_score(self.actual,self.pred)}
